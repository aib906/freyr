...
/**
 * @Author: zjs
 * @Date: 2021/1/30 7:21 下午
 */
@Component
public class FreyrContainerManager extends AbstractContainerManager {

    private final ConcurrentHashMap<String, AbstractContainer> registeredContainer = new ConcurrentHashMap<>();

    public FreyrCommonContainer provideContainer( PluginChain chain) {
        String identity = chain.getName();
